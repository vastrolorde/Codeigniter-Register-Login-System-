...
<head>
    ...
    <link href="<?php echo base_url();?>/assets/admin/css/print-invoice.css" rel="stylesheet" media="print">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-file-text"></i> <span>Extra Pages</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/invoice"> Invoice</a></li>
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <div class="invoice-logo">
                                    <img src="<?php echo base_url();?>/assets/admin/img/invoice-logo.png" alt=""/>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <h1>invoice</h1>
