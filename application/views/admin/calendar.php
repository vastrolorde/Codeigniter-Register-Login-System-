                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-cogs"></i> <span>Components <span class="badge noti-arrow bg-success pull-right">3</span> </span></a>
                        <ul class="child-list">                            
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/calendar"> Calendar</a></li>
...
<script src="<?php echo base_url();?>assets/admin/js/dragging-calendar-event-init.js"></script>
