...
<head>
    ...
    <!--theme color layout-->
    <link href="<?php echo base_url();?>/assets/admin/css/layout-theme-three.css" rel="stylesheet">
...
<body class="sticky-header">
    ...
    <section>
        ...
        <div class="sidebar-left">
            ...
            <div class="logo bg-danger visible-xs-* visible-sm-*">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                    <li class="menu-list">
                        <a href=""><i class="fa fa-laptop"></i>  <span>Layouts</span></a>
                        <ul class="child-list">
                            <li><a href="javascript:;"> Blank page</a></li>
                            <li><a href="javascript:;"> Boxed Page</a></li>
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>UI Elements</span></a>
                        <ul class="child-list">
                            <li><a href="javascript:;"> BS Elements</a></li>
                            <li><a href="javascript:;"> Buttons</a></li>
                            <li><a href="javascript:;"> Widgets</a></li>
                            <li><a href="javascript:;"> Slider</a></li>
                            <li><a href="javascript:;"> Tree View</a></li>
                            <li><a href="javascript:;"> Nestable</a></li>
                            <li><a href="javascript:;"> Fontawesome</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-cogs"></i> <span>Components <span class="badge noti-arrow bg-success pull-right">3</span> </span></a>
                        <ul class="child-list">
                            <li><a href="javascript:;"> Grids</a></li>
                    ...
                    <li class="menu-list"><a href="javascript:;"><i class="fa fa-th-list"></i> <span>Data Tables</span></a>
                        <ul class="child-list">
                            <li><a href="javascript:;"> Basic Table</a></li>
                            <li><a href="javascript:;"> Advanced Table</a></li>
                        </ul>
                    </li>

                    <li class="menu-list"><a href=""><i class="fa fa-tasks"></i> <span>Forms</span></a>
                        <ul class="child-list">
                            <li><a href="javascript:;"> Form Layouts</a></li>
                            <li><a href="javascript:;"> Advanced Components</a></li>
                            <li><a href="javascript:;"> Form Wizards</a></li>
                            <li><a href="javascript:;"> Form Validation</a></li>
                            <li><a href="javascript:;"> Editors</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-list"><a href="javascript:;"><i class="fa fa-envelope-o"></i> <span>Email <span class="label noti-arrow bg-danger pull-right">4 Unread</span> </span></a>
                        <ul class="child-list">
                            ...
                            <li><a href="javascript:;"> View Mail</a></li>
                            <li><a href="javascript:;"> Compose Mail</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-file-text"></i> <span>Extra Pages</span></a>
                        <ul class="child-list">
                            ...
                            <li><a href="javascript:;"> Pricing Table</a></li>
                            <li><a href="javascript:;"> Time Line</a></li>
                            <li><a href="javascript:;"> 404 Error</a></li>
                            <li><a href="javascript:;"> 500 Error</a></li>
        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <div class="header-section">
                ...
                <div class="logo bg-danger hidden-xs hidden-sm">
                    <a href="http://localhost/codeigniter/corlate/index.php/admin/">
                        <img src="<?php echo base_url();?>/assets/admin/img/logo-icon.png" alt="">
                        <!--<i class="fa fa-maxcdn"></i>-->
                        <span class="brand-name">SlickLab</span>
                ...
                <div class="icon-logo bg-danger hidden-xs hidden-sm">
                    <a href="http://localhost/codeigniter/corlate/index.php/admin/">
                        <img src="<?php echo base_url();?>/assets/admin/img/logo-icon.png" alt="">
                        <!--<i class="fa fa-maxcdn"></i>-->
                    </a>
