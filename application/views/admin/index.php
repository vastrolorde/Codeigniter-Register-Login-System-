        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li><a href="http://localhost/codeigniter/corlate/index.php/admin/userlistpage"><i class="fa fa-home"></i> <span>User Records</span></a></li>
					<li class="menu-list">
                            ...
                            <div class="post-info">
                                <ul class="team-list cycle-pager external" id='no-template-pager'>
                                    ...
                                    <li>
                                        <a href="javascript:;">
                                            <span class="thumb-small">
                                                <img class="circle" src="<?php echo base_url();?>/assets/admin/img/img4.jpg" alt=""/>
