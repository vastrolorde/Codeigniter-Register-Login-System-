...
<head>
    ...
    <!--nestable-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/admin/js/nestable/jquery.nestable.css" />
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-book"></i> <span>UI Elements</span></a>
                        <ul class="child-list">                       
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/nestable"> Nestable</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="border-head">
                            <h4>Serialised Output (per list)</h4>
                        </div>
...
<!--nestable -->
<script src="<?php echo base_url();?>/assets/admin/js/nestable/jquery.nestable.js"></script>
<script src="<?php echo base_url();?>/assets/admin/js/nestable-init.js"></script>
