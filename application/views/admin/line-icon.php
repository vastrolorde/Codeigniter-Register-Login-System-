...
<head>
    ...
    <title>SlickLab - Line Icon</title>
    ...
    <section>
        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li><a href="http://localhost/codeigniter/corlate/index.php/admin/"><i class="ico icon-home"></i> <span>Dashboard</span></a></li>
                    <li class="menu-list">
                        <a href=""><i class="ico icon-layers"></i>  <span>Layouts</span></a>
                        <ul class="child-list">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="ico icon-graduation"></i> <span>UI Elements</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/lineicon"> Line Icon</a></li>
                        </ul>
                    </li>
                    <li>
                        <h3 class="navigation-title">Components</h3>
                    </li>
                    <li class="menu-list"><a href=""><i class="ico icon-cup"></i> <span>Components <span class="badge noti-arrow bg-success pull-right">3</span> </span></a>
                        <ul class="child-list">
                    ...
                    <li class="menu-list"><a href="javascript:;"><i class="ico icon-grid"></i> <span>Data Tables</span></a>
                        <ul class="child-list">
                    ...
                    <li class="menu-list"><a href=""><i class="ico icon-drawer"></i> <span>Forms</span></a>
                        <ul class="child-list">
                    ...
                    <li class="menu-list"><a href=""><i class="ico icon-pie-chart"></i> <span>Charts </span></a>
                        <ul class="child-list">
                    ...
                    <li class="menu-list"><a href="javascript:;"><i class="ico icon-envelope"></i> <span>Email <span class="label noti-arrow bg-danger pull-right">4 Unread</span> </span></a>
                        <ul class="child-list">
                    ...
                    <li class="menu-list"><a href="javascript:;"><i class="ico icon-map"></i> <span>Maps</span></a>
                        <ul class="child-list">
                    ...
                    <li class="menu-list"><a href=""><i class="ico icon-doc"></i> <span>Extra Pages</span></a>
                        <ul class="child-list">
        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <div class="page-head">
                ...
                <span class="sub-title"> Beautifuly Crafted Webfont Icons </span>
            </div>
            <!-- page head end-->
            ...
            <div class="wrapper">
                ...
                <div class="row simple-icon-list">
