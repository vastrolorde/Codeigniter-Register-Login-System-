                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-bar-chart-o"></i> <span>Charts </span></a>
                        <ul class="child-list">
                          <li><a href="http://localhost/codeigniter/corlate/index.php/admin/flotchart"> Flot Charts</a></li>
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/chartjs"> Chartjs</a></li>                            
                        </ul>
                    </li>
                    <li>
                    ...
                    <div class="col-md-6">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="chartJS">
                                    <canvas id="bar-chart-js" height="240" width="100%" ></canvas>
                                </div>
                            </div>
                        </section>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="chartJS">
                                    <canvas id="pie-chart-js" height="240" width="100%" ></canvas>
                                </div>
                            </div>
                        </section>
                    </div>
...
<!--Chart JS-->
<script src="<?php echo base_url();?>assets/admin/js/chart-js/chart.js"></script>
<script src="<?php echo base_url();?>assets/admin/js/chartJs-init.js"></script>
