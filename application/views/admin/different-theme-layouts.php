...
<head>
    ...
    <title>SlickLab - different theme layouts</title>
    ...
    <section>
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active">
                        ...
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/differentthemelayouts"> Different Theme Layouts</a></li>                   
                        </ul>
                    </li>
        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        ...
                        <li class="active">Different Theme Layouts</li>
                    </ol>
                </div>
            ...
            <div class="wrapper">
                ...
                <p class="m-b-30">
                    Here are some sample layout theme pages. But you can made any color combination using layout theme css within a minute.
                </p>
                <div class="row m-b-30">
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <h5>Default Layout Theme</h5>
                        <div class="d-theme">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/blankpage" target="_blank"><img src="<?php echo base_url();?>assets/admin/img/layout/default-layout.jpg" alt=""/></a>
                        </div>
                        <div class="text-center m-t-30">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/blankpage" target="_blank" class="btn btn-xs btn-info">View Demo</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <h5>Layout [ Sticky Sidebar ]</h5>
                        <div class="d-theme">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/stickysidebar" target="_blank"><img src="<?php echo base_url();?>assets/admin/img/layout/sticky-sidebar.jpg" alt=""/></a>
                        </div>
                        <div class="text-center m-t-30">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/stickysidebar" target="_blank" class="btn btn-xs btn-info">View Demo</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <h5>Layout [ Non Sticky Header & Sidebar ]</h5>
                        <div class="d-theme">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/nonstickyheadersidebar" target="_blank"><img src="<?php echo base_url();?>assets/admin/img/layout/non_sticky.jpg" alt=""/></a>
                        </div>
                        <div class="text-center m-t-30">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/nonstickyheadersidebar" target="_blank" class="btn btn-xs btn-info">View Demo</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <h5>Layout Theme One</h5>
                        <div class="d-theme">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/layout1" target="_blank"><img src="<?php echo base_url();?>assets/admin/img/layout/layout1.jpg" alt=""/></a>
                        </div>
                        <div class="text-center m-t-30">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/layout1" target="_blank" class="btn btn-xs btn-info">View Demo</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <h5>Layout Theme Two</h5>

                        <div class="d-theme">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/layout2" target="_blank"><img src="<?php echo base_url();?>assets/admin/img/layout/layout2.jpg" alt=""/></a>
                        </div>
                        <div class="text-center m-t-30">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/layout2" target="_blank" class="btn btn-xs btn-info">View Demo</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <h5>Layout Theme Three</h5>

                        <div class="d-theme">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/layout3" target="_blank"><img src="<?php echo base_url();?>assets/admin/img/layout/layout3.jpg" alt=""/></a>
                        </div>
                        <div class="text-center m-t-30">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/layout3" target="_blank" class="btn btn-xs btn-info">View Demo</a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <h5>Layout Theme Four</h5>

                        <div class="d-theme">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/layout4" target="_blank"><img src="<?php echo base_url();?>assets/admin/img/layout/layout4.jpg" alt=""/></a>
                        </div>
                        <div class="text-center m-t-30">
                            <a href="http://localhost/codeigniter/corlate/index.php/admin/layout4" target="_blank" class="btn btn-xs btn-info">View Demo</a>
                        </div>
                    </div>
                </div>
