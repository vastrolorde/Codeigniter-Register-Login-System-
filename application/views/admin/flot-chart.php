...
<head>
    ...
    <title>SlickLab - flot chart</title>
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-bar-chart-o"></i> <span>Charts </span></a>
                        <ul class="child-list">                            
                           <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/flotchart"> Flot Charts</a></li>
...
<!--flot initialization-->
<script src="<?php echo base_url();?>assets/admin/js/flot-chart-init.js"></script>
