...
<head>
    ...
    <title>SlickLab - google map</title>
        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href="javascript:;"><i class="fa fa-map-marker"></i> <span>Maps</span></a>
                        <ul class="child-list">
                            
							<li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/googlemap"> Google Map</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-inline map-search" role="form">
...
<script src="<?php echo base_url();?>/assets/admin/js/gmaps.js"></script>

<!--common scripts for all pages-->
<script src="<?php echo base_url();?>/assets/admin/js/scripts.js"></script>

<script src="<?php echo base_url();?>/assets/admin/js/gmaps-init.js"></script>
