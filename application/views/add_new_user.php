...
<section id="contact-page"><br><br>
        <div class="container">
            <div class="center">        
                <h2 class="leadme">Add A New User</h2>
            ...
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="http://localhost/codeigniter/corlate/index.php/home/newuseradd" >
                    <div class="col-sm-4 col-sm-offset-4">
                        <div class="form-group">
                            <label style="color:#800000;font-weight:bold;">Name *</label>
                            <input type="text" name="name" class="form-control" placeholder="Enter Your Full Name">
                        </div>
						<div class="form-group">
                            <label style="color:#800000;font-weight:bold;">User Name *</label>
                            <input type="text" name="uname" class="form-control" placeholder="Enter Your User Name">
                        </div>
                        <div class="form-group">
                            <label style="color:#800000;font-weight:bold;">Email *</label>
                            <input type="email" name="email" class="form-control" placeholder="Enter Your Phone Email ID">
                        </div>
                        <div class="form-group">
                            <label style="color:#800000;font-weight:bold;">Phone</label>
                        ...
                        <div class="form-group">
                            <label style="color:#800000;font-weight:bold;">Confirm Password *</label>
                            <input type="password" name="cpass" class="form-control" required="required" placeholder="Re Enter Your Password">
                        </div> 						
                    </div>                                  
