...
<head>
    ...
    <title>SlickLab - Form Wizard</title>
    ...
    <!--Form Wizard-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/admin/css/jquery.steps.css" />
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-tasks"></i> <span>Forms</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/formwizard"> Form Wizards</a></li>
                            ...
                            <form id="basic-form" action="#">
                                <div>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="col-lg-12">
                                                <ul>
                                                    <li>Vector </li>
                                                    <li>Lab</li>
                                                    <li>dkmosa@gmail.com</li>
                                                    <li>dream city, Dreamland</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <section>
                                        <div class="form-group clearfix">
                                            <div class="col-lg-12">
                                                <input id="accept-Terms" name="acceptTerms" type="checkbox" class="required">
...
<!--Form Validation-->
<script src="<?php echo base_url();?>assets/admin/js/bootstrap-validator.min.js" type="text/javascript"></script>

<!--Form Wizard-->
<script src="<?php echo base_url();?>assets/admin/js/jquery.steps.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/admin/js/jquery.validate.min.js" type="text/javascript"></script>

<!--wizard initialization-->
<script src="<?php echo base_url();?>assets/admin/js/wizard-init.js" type="text/javascript"></script>
