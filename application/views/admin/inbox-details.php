...
<head>
    ...
    <title>SlickLab -  inbox details </title>
        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href="javascript:;"><i class="fa fa-envelope-o"></i> <span>Email <span class="label noti-arrow bg-danger pull-right">4 Unread</span> </span></a>
                        <ul class="child-list">
                            <li><a href="http://localhost/codeigniter/corlate/index.php/admin/inbox"> Inbox</a></li>
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/inboxdetails"> View Mail</a></li>
        ...
        <div class="body-content">
            ...
            <aside class="lg-side" style="height: 1200px">
                ...
                <div class="inbox-body">
                    ...
                    <div class="sender-info">
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                <div class="pull-left">
                                    <img alt="" src="<?php echo base_url();?>/assets/admin/img/img2.jpg">
                                </div>
                                <div class="s-info">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="compose-btn pull-right">
                                    <a class="btn btn-sm btn-default" href="http://localhost/codeigniter/corlate/index.php/admin/inboxcompose"><i class="fa fa-reply"></i> Reply</a>
                        ...
                        <ul>
                            <li>
                                <a href="#" class="atch-thumb">
                                    <img src="<?php echo base_url();?>/assets/admin/img/img-attachment.jpg">
                                </a>
                            ...
                            <li>
                                <a href="#" class="atch-thumb">
                                    <img src="<?php echo base_url();?>/assets/admin/img/pdf-attachment.jpg">
                                </a>
                    ...
                    <div class="compose-btn pull-right">
                        <a class="btn  btn-success" href="http://localhost/codeigniter/corlate/index.php/admin/inboxcompose"> Reply Mail</a>
                    </div>
                </div>
            </aside>
            </div>
