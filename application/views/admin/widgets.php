...
<head>
    ...
    <!--toastr-->
    <link href="<?php echo base_url();?>/assets/admin/js/toastr-master/toastr.css" rel="stylesheet" type="text/css" />
    ...
    <section>
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>UI Elements</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/widgets"> Widgets</a></li>
        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <div class="row state-overview state-alt">
                <div class="col-lg-3 col-sm-6">
                    <section class="panel y-border">
                        <div class="symbol ">
                            <span class="bg-warning"><i class="fa fa-legal"></i></span>
                        </div>
                        <div class="value">
                            <h1>
                                320
            ...
            <div class="col-md-6">
                <section class="panel">
                    <div class="user-head">
                        <img src="<?php echo base_url();?>/assets/admin/img/w-p-img.jpg" alt=""/>
                    </div>
                    <div class="panel-body">
                        <div class="user-desk">
                            <div class="avatar">
                                <img src="<?php echo base_url();?>/assets/admin/img/img1.jpg" alt=""/>
                            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="monthly-page-view w-p-view-">
                            <li class="pull-left page-view-label">
                                <span class="page-view-value"> 93,205</span>
                ...
                <section class="panel black-bg">
                    <div class="panel-body">
                        <!--monthly page view start-->
                        <ul class="monthly-page-view w-p-view-">
                            <li class="pull-left page-view-label">
                                <span class="page-view-value wht-color"> 93,205</span>
                                <span>Monthly Page views</span>
                            </li>
                            <li class="pull-right">
                                <div id="m-g-dark" class="chart"><canvas width="131" height="35" style="display: inline-block; width: 131px; height: 35px; vertical-align: top;"></canvas></div>
                            </li>
                        </ul>
                        <!--monthly page view end-->
                    </div>
            ...
            <div class="col-md-6">
                        ...
                        <div class="tab-content">
                            <div id="clock" class="tab-pane active">
                                <div class="media">
                                    <a class="media-left media-middle" href="#">
                                        <img class="img-circle" alt="" src="<?php echo base_url();?>/assets/admin/img/img4.jpg" data-holder-rendered="true" style="width: 80px; height: 80px;">
                                    </a>
                            ...
                            <div id="heart" class="tab-pane">
                                <div class="media fav-list">
                                    <a class="media-left media-middle" href="#">
                                        <img class="img-circle" alt="" src="<?php echo base_url();?>/assets/admin/img/img1.jpg" data-holder-rendered="true" >
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media fav-list">
                                    <a class="media-left media-middle" href="#">
                                        <img class="img-circle" alt="" src="<?php echo base_url();?>/assets/admin/img/img4.jpg" data-holder-rendered="true">
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-heading text-uppercase">kayne west</h4>
                                        <div class="text-muted space-i">
                            ...
                            <div id="music" class="tab-pane">
                                <ul class="w-m-list">
                                    <li>
                                        <i class="fa fa-music"></i>  Holloween Parade <small class="text-muted">- Lou Reed 3:29</small>
                                    </li>
                                    <li>
                ...
                <section class="panel">
                    <div class="weather-wallpaper">
                        <img src="<?php echo base_url();?>/assets/admin/img/weather-1.jpg" alt=""/>
                        <div class="w-location">
                            <i class="slicon-weather_downpour_fullmoon"></i>
                            <span class="degree">13 </span> <span> C Melborn</span>
                        </div>
                    </div>
                    <div class="panel-body">
                        <ul class="weather-list">
                            ...
                            <li>
                                <h5>Tue</h5>
                                <i class="slicon-weather_tempest_fullmoon"></i>
                                <div class="degree">10</div>
                            </li>
                            <li>
                                <h5>Wed</h5>
                                <i class="slicon-weather_snow_halfmoon"></i>
                                <div class="degree">17</div>
                            </li>
                            <li>
                                <h5>Thu</h5>
                                <i class="slicon-weather_sundown"></i>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="team-m">
                            ...
                            <a href="#">
                                <img src="<?php echo base_url();?>/assets/admin/img/img2.jpg" alt="">
                            </a>
                            <a href="#">
                                <img src="<?php echo base_url();?>/assets/admin/img/img4.jpg" alt="">
                                <i class="busy dot"></i>
                            </a>
                            <a href="#">
                                <img src="<?php echo base_url();?>/assets/admin/img/img3.jpg" alt="">
                            </a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <section class="panel">
                        <div id="c-slide" class="carousel slide auto panel-body news-c">
                            ...
                            <div class="carousel-inner ">
                                <div class="item active">
                                    <div class="media">
                                        <a class="media-left media-middle" href="#">
                                            <img class="img-circle" alt="" src="<?php echo base_url();?>/assets/admin/img/p-img-1.jpg" data-holder-rendered="true" style="width: 80px; height: 80px;">
                                        </a>
                                        <div class="media-body">
                                            <p>RECENT NEWS</p>
                                            <h4 class="media-heading text-uppercase">
                                                <a href="#" class="green-color">Summer Discount for Deluxe Suite</a>
                                            </h4>
                                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor sit amet consiquet</p>
                                        </div>
                                        <div class="media-right n-comments">
                                ...
                                <div class="item">
                                    <div class="media">
                                        <a class="media-left media-middle" href="#">
                                            <img class="img-circle" alt="" src="<?php echo base_url();?>/assets/admin/img/p-img-2.jpg" data-holder-rendered="true" style="width: 80px; height: 80px;">
                                        </a>
                                        <div class="media-body">
                                            <p>RECENT NEWS</p>
                                            <h4 class="media-heading text-uppercase ">
                                                <a href="#" class="green-color">Bird is waiting to catch fish</a>
                                            </h4>
                                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor sit amet consiquet</p>
                                        </div>
                                        <div class="media-right n-comments">
                                ...
                                <div class="item ">
                                    <div class="media">
                                        <a class="media-left media-middle" href="#">
                                            <img class="img-circle" alt="" src="<?php echo base_url();?>/assets/admin/img/p-img-3.jpg" data-holder-rendered="true" style="width: 80px; height: 80px;">
                                        </a>
                                        <div class="media-body">
                                            <p>RECENT NEWS</p>
                                            <h4 class="media-heading text-uppercase ">
                                                <a href="#" class="green-color">High way roads looks nice</a>
                                            </h4>
                                            <p>Lorem ipsum dolor sit amet lorem ipsum dolor sit amet consiquet</p>
                                        </div>
                                        <div class="media-right n-comments">
                ...
                <div class="col-md-12">
                    <section class="panel">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="k-avatar">
                                    <img src="<?php echo base_url();?>/assets/admin/img/k-img.jpg" alt=""/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="panel-body text-center">
                                    ...
                                    <div class="k-info">
                                        ...
                                        <p>Lorem ipsum dolor sit amet lorem ipsum dolor
                                            sit amet consiquet</p>
                                    </div>
                                    <a href="#" class="btn btn-dark text-uppercase">Read More</a>
                                </div>
                            </div>
                        </div>
                    </section>
            ...
            <div class="col-md-4">
                ...
                <div class="twt-feed light-bg m-b-20">
                    <img src="<?php echo base_url();?>/assets/admin/img/img2.jpg" alt="">
                        ...
                        <ul class="team-list chat-list-side info statistics border-less-list setting-list">
                            ...
                            <li>
                                <div class="inline">
                                    ...
                                    <span class="thumb-small">
                                        <input type="checkbox" class="js-switch-small-red" />
                                    </span>
                            </li>
                ...
                <section class="panel">
                    <div class="panel-body">
                        <form role="form">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info btn-block w-pad">Submit</button>
                            </div>
                            <div class="text-center">
                                <a href="#" class="w-login">Forgot your password?</a>
                            </div>

                        </form>

                    </div>
                    <div class="panel-footer w-foot">
                        <a href="#">
                ...
                <section class="panel">
                    <div class="panel-body">
                        <div  class="todo w-pie-chart" data-percent="45"><span>45</span>%</div>
                        <div class="text-center w-info">
                            <h3>To Do</h3>
                ...
                <section class="panel">
                    <div class="panel-body">
                        <div class="s-p-info text-center">
                            <div class="avatar">
                                <img class="img-circle" src="<?php echo base_url();?>/assets/admin/img/img2.jpg" alt=""/>
                            </div>
