...
<body class="sticky-header">
    ...
    <section>
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>UI Elements</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/toastr"> Toaster Notification</a></li>
        ...
        <!-- body content start-->
        <div class="body-content" style="min-height: 1400px;">
                        ...
                        <div class="row toastr-row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="message" rows="3" placeholder="Enter a message ..." >Slicklab is an Awesome dashboard build with BS3 </textarea>
                                </div>
                                <div class="form-group">

                                    <label class="checkbox-custom check-success">
                                        <input type="checkbox" checked value="checked" id="closeButton"> <label for="closeButton">Close Button</label>
                                        <input type="checkbox" value="checked" id="addBehaviorOnToastClick"> <label for="addBehaviorOnToastClick">Add behavior on toast click</label>
                                        <input type="checkbox" value="checked" id="debugInfo"> <label for="debugInfo">Debug</label>
                                        <input type="checkbox" value="checked" id="progressBar"> <label for="progressBar">Progress Bar</label>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group" id="toastTypeGroup">
                                    ...
                                    <div class="radio-custom radio-primary">
                                        ...
                                        <input type="radio" name="toasts" value="info-t" id="info-t">
                                ...
                                <div class="form-group" id="positionGroup">
                                    ...
                                    <div class="radio-custom radio-primary">
                                        ...
                                        <label for="top-full-width">Top Full Width </label>

                                        <input type="radio" name="positions" value="toast-bottom-full-width" id="bottom-full-width">
                                        <label for="bottom-full-width">Bottom Full Width </label>
