    ...
    <section>
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-cogs"></i> <span>Components <span class="badge noti-arrow bg-success pull-right">3</span> </span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/grid"> Grids</a></li>
        ...
        <div class="body-content" style="min-height: 1100px;">
            ...
            <div class="page-head">
                ...
                <span class="sub-title">Sub tittle goes here</span>
            </div>
            <!-- page head end-->
