...
<head>
    ...
    <title>SlickLab - form validation</title>
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-tasks"></i> <span>Forms</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/formvalidation"> Form Validation</a></li>
...
<script src="<?php echo base_url();?>assets/admin/js/form-validation-init.js"></script>
