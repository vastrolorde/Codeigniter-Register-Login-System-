        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="http://localhost/codeigniter/corlate/index.php"><img src="<?php echo base_url('assets/images/logo.png');?>" alt="logo"></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/home/errorpage">404</a></li>
