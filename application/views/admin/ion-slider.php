...
<head>
    ...
    <title>SlickLab - ion slider</title>
    ...
    <!--ion-rangeSlider-->
    <link href="<?php echo base_url();?>/assets/admin/js/ion-rangeSlider/css/ion.rangeSlider.css" rel="stylesheet"/>
    <link href="<?php echo base_url();?>/assets/admin/js/ion-rangeSlider/css/ion-custom-slicklab.css" rel="stylesheet"/>
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-book"></i> <span>UI Elements</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/ionslider"> Ion Slider</a></li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel">
                            ...
                            <div class="panel-body ion-list">
                                <div class="primary"><input type="text" id="range_color_1" value="" name="range" /></div>
                                <div class="success"><input type="text" id="range_color_2" value="" name="range" /></div>
                                <div class="info"><input type="text" id="range_color_3" value="" name="range" /></div>
                                <div class="warning"><input type="text" id="range_color_4" value="" name="range" /></div>
                                <div class="danger"><input type="text" id="range_color_5" value="" name="range" /></div>
                            </div>
                        </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body ion-list">
                                ...
                                <div><input type="text" id="range_02" value="" name="range" /></div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body ion-list">
                                ...
                                <div><input type="text" id="range_04" value="" name="range" /></div>
                                <p>Using step 250</p>
                                <div><input type="text" id="range_05" value="" name="range" /></div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body ion-list">
                                ...
                                <div><input type="text" id="range_07" value="" name="range" /></div>
                                <p>Using any strings as your values</p>
                                <div><input type="text" id="range_08" value="" name="range" /></div>
                    ...
                    <div class="col-md-6">
                        <div class="panel">
                            ...
                            <div class="panel-body ion-list">
                                ...
                                <div><input type="text" id="range_10" value="" name="range" /></div>
                                <p>Prettify enabled. Much better!</p>
                                <div><input type="text" id="range_11" value="" name="range" /></div>
                                <p>Don't like space as separator? Use anything you like!</p>
                                <div><input type="text" id="range_12" value="" name="range" /></div>
                                <p>You don't like default prettify function? Use your own!</p>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body ion-list">
                                <p>Using prefixes</p>
                                <div><input type="text" id="range_14" value="" name="range" /></div>
                                <p>Using postfixes</p>
                                <div><input type="text" id="range_15" value="" name="range" /></div>
                                <p>Whant to show that max number is not the biggest one?</p>
                                <div><input type="text" id="range_16" value="" name="range" /></div>
                                <p>Taking care about how from and to values connect? Use decorate_both option:</p>
                                <div><input type="text" id="range_17" value="" name="range" /></div>
                                <p>Remove double decoration</p>
                                <div><input type="text" id="range_18" value="" name="range" /></div>
                                <p>Use your own separator symbol with values_separator option. Like →</p>
                                <div><input type="text" id="range_19" value="" name="range" /></div>
                                <p>Or " to ":</p>
...
<!--ion-rangeSlider-->
<script src="<?php echo base_url();?>/assets/admin/js/ion-rangeSlider/js/ion.rangeSlider.js"></script>
<script src="<?php echo base_url();?>/assets/admin/js/ion-slider-init.js"></script>
