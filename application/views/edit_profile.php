...
<section id="contact-page"><br><br>
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="http://localhost/codeigniter/corlate/index.php/home/updateuserprofile" >
                    <div class="col-sm-4 col-sm-offset-4">
                        <div class="form-group">
                            <label style="color:black;"><b>Name:</b></label>
			    <input type="hidden" name="eid" class="form-control" placeholder="Enter Your Full Name" value="<?php echo $sdata->id; ?>">			
                            <input type="text" name="name" class="form-control" placeholder="Enter Your Full Name" value="<?php echo $sdata->name; ?>">
                        </div>
						<div class="form-group">
                            <label style="color:black;"><b>User Name:</b></label>
                            <input type="text" name="uname" class="form-control" placeholder="Enter Your User Name" value="<?php echo $sdata->uname; ?>">
                        </div>
                        <div class="form-group">
                            <label style="color:black;"><b>Email:</b></label>
                            <input type="email" name="email" class="form-control" placeholder="Enter Your Phone Email ID" value="<?php echo $sdata->email; ?>">
                        </div>
                        <div class="form-group">
                            <label style="color:black;"><b>Phone:</b></label>
                            <input type="number" name="phone" class="form-control" placeholder="Enter Your Phone Number" value="<?php echo $sdata->phone; ?>">
                        </div>                         
                       <div class="form-group">				
       ...
       <div class="col-sm-4 col-sm-offset-1"> 
        <form method="post" action="http://localhost/codeigniter/corlate/index.php/home/userlistpage" ><button type="submit" name="submit" class="btn btn-success btn-lg" required="required">Go Back To User List Page</button></form>
       </div>
        <!--		  				   
		<div class="col-sm-4 col-sm-offset-4">            	
