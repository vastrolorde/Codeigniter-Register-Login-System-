...
<head>
    ...
    <!--theme color layout-->
    <link href="<?php echo base_url();?>/assets/admin/css/layout-theme-two.css" rel="stylesheet">
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            ...
                                            <ul class="col-sm-3 list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="http://localhost/codeigniter/corlate/index.php/admin/img/mega-menu/mega_icon4.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Easy to Cutomize</span>
                                                                <span class="d-desk">Very easy to use</span>
                                                                </span>
