...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/admin/js/bootstrap-fileinput-master/css/fileinput.css" />
        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href=""><i class="fa fa-cogs"></i> <span>Components <span class="badge noti-arrow bg-success pull-right">3</span> </span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/gallery"> Gallery </a></li>
                        </ul>
                    </li>
        ...
        <div class="body-content" >
            ...
            <aside class="p-aside">
                ...
                <ul class="gallery">
                    <li>
                        <a href="#">
                            <img src="<?php echo base_url();?>/assets/admin/img/gallery/1.jpg" alt=""/>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo base_url();?>/assets/admin/img/gallery/2.jpg" alt=""/>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo base_url();?>/assets/admin/img/gallery/3.jpg" alt=""/>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo base_url();?>/assets/admin/img/gallery/6.jpg" alt=""/>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo base_url();?>/assets/admin/img/gallery/5.jpg" alt=""/>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo base_url();?>/assets/admin/img/gallery/4.jpg" alt=""/>
                        </a>
                    </li>
                    <li>
                        <a href="#">
...
<!--bootstrap-fileinput-master-->
<script type="text/javascript" src="<?php echo base_url();?>/assets/admin/js/bootstrap-fileinput-master/js/fileinput.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/assets/admin/js/file-input-init.js"></script>
