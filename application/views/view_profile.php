...
<section id="contact-page"><br><br>
            ...
            <div class="row contact-wrap"> 
			 ...
			 -->
				 <div class="center">
                     ...
                     <img style="width: 250px;height: 250px;border-radius:50%;" onerror="this.src='<?php echo base_url().'/profile_images/download.png';?>'" src="<?php echo base_url().'/profile_images/'.$row->image; ?>" >
				  </div>
		      <div>
				 <table border="0" align="center">
					 ...
					 <tr>
					    <td style="padding-bottom:20px;color:black;"><b><i>Password:</i></b>&nbsp;&nbsp;&nbsp;</td>
						<td style="padding-bottom:20px;" align="center"><?php echo $row->password; ?></td>
					 </tr>                                         
					<?php } ?>
                                     </tbody>
				  </table>
		...
		<div class="center">
            <form method="post" action="<?php echo base_url().'index.php/home/updateprofilepage/'.$row->id; ?>"><p><input type="submit" value="Edit Your Profile Now"></p></form>
