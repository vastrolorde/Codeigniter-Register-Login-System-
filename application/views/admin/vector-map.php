...
<head>
    ...
    <title>SlickLab - vector map</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>/assets/admin/js/vector-map/jqvmap/jqvmap.css">
                    ...
                    <li class="menu-list"><a href="javascript:;"><i class="fa fa-map-marker"></i> <span>Maps</span></a>
                        <ul class="child-list">
                           <li><a href="http://localhost/codeigniter/corlate/index.php/admin/googlemap"> Google Map</a></li>
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/vectormap"> Vector Map</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-md-6">
                        <section class="panel" >
                            ...
                            <div class="panel-body">
                                <div id="world-vmap" class="vmap-space"></div>
                            </div>
                        </section>
                    </div>
                    <div class="col-md-6">
                        <section class="panel" >
                            ...
                            <div class="panel-body">
                                <div id="europe-vmap" class="vmap-space"></div>
                            </div>
                        </section>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <section class="panel" >
                            ...
                            <div class="panel-body">
                                <div id="asia-vmap" class="vmap-space"></div>
                            </div>
                        </section>
                    </div>
                    <div class="col-md-6">
                        <section class="panel" >
                            ...
                            <div class="panel-body">
                                <div id="australia-vmap" class="vmap-space"></div>
                            </div>
                        </section>
                    </div>
...
<!--vectormap-->
<script src="<?php echo base_url();?>/assets/admin/js/vector-map/jqvmap/jquery.vmap.js"></script>
<script src="<?php echo base_url();?>/assets/admin/js/vector-map/jqvmap/maps/jquery.vmap.world.js"></script>
<script src="<?php echo base_url();?>/assets/admin/js/vector-map/jqvmap/data/jquery.vmap.sampledata.js"></script>
<script src="<?php echo base_url();?>/assets/admin/js/vector-map/jqvmap/maps/continents/jquery.vmap.europe.js"></script>
<script src="<?php echo base_url();?>/assets/admin/js/vector-map/jqvmap/maps/continents/jquery.vmap.asia.js"></script>
<script src="<?php echo base_url();?>/assets/admin/js/vector-map/jqvmap/maps/continents/jquery.vmap.australia.js"></script>

<!--vectormap inti-->
<script src="<?php echo base_url();?>/assets/admin/js/vmap-init.js"></script>
