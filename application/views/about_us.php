...
<body>
    ...
    <section id="about-us">
        <div class="center">   
            ...
            <?php echo '<h3 style="color:#800000;"><b>You Are Logged in With Your Facebook Account</b></h3>'; ?>
            <?php echo "Click here To log out&nbsp;&nbsp;<a href='$logout_url' class='btn btn-success'>Log Out</a>"; ?> 
            <?php } ?>   
