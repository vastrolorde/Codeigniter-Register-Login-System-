...
<head>
    ...
    <!--fuelux tree-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/admin/js/fuelux/css/tree-style.css" />
               ...
               <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>UI Elements</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="http://localhost/codeigniter/corlate/index.php/admin/tree"> Tree View</a></li>
...
<script src="<?php echo base_url();?>/assets/admin/js/tree-init.js"></script>
