	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1 style="color:black" align="center">Login successful!</h1>
			</div>
		 <div id="ranjan">
           ...
           <?php $msg=$this->session->userdata('update_pass'); ?>
            <?php if($msg){ ?>
            <?php echo $msg; ?>
            <?php $this->session->unset_userdata('update_pass'); ?>
           <?php } ?>
                     <?php $fmsg=$this->session->userdata('update_pass_fail'); ?>
                        <?php if($fmsg){ ?>
                          <?php echo $fmsg; ?>
                        <?php $this->session->unset_userdata('update_pass_fail'); ?>
                     <?php } ?>
	      <p>You are now logged in.</p>
			<form method="post" action="http://localhost/codeigniter/corlate/index.php/home/viewprofile" ><p>Click Here To View Your Profile &nbsp;&nbsp;<input type="submit" name="view_profile" value="View Profile"></p></form>
			<form method="post" action="http://localhost/codeigniter/corlate/index.php/home/change_pass" ><p>Click Here To Change Password &nbsp;&nbsp;<input type="submit" name="Change_password" value="Change Password"></p></form>
