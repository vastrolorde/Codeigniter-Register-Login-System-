	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h5 style="color:black" align="center">You need to Log Out in order to Sign up or Log in!</h5>
			</div>
		 <div id="ranjan">
		    <blockquote style="border: 2px solid #666; padding: 20px; background-color: #ccc; text-align:center; ">
                <h2 style="color:black">You are already Logged in as:</h2>
				<h1 style="color:green"><?php echo $this->session->userdata('name'); ?> </h1>
			  </blockquote>
	      <p>Log out First and then try Again...</p>
		    <form method="post" action="http://localhost/codeigniter/corlate/index.php/home/viewprofile" ><p>Click Here To Edit Profile &nbsp;&nbsp;<input type="submit" value="View Profile"></p></form>
			<form method="post" action="http://localhost/codeigniter/corlate/index.php/home/logout" ><p>Click Here To Logout &nbsp;&nbsp;<input type="submit" value="Log Out"></p></form>
		  </div>
		</div>
	</div><!-- .row -->
</div><!-- .container -->
